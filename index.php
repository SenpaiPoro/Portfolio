                        ...
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" style="color: #FFF;" href="resume.php?id=<?=$paramResult?>">Resume</a>
                                    <a class="btn btn-outline-info btn-lg px-5 py-3 fs-6 fw-bolder" href="projects.php?id=<?=$paramResult?>">Projects</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="assets/<?php echo $data['profile'];?>" alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
